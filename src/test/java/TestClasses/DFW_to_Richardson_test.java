...
public class DFW_to_Richardson_test extends BaseClass {

    DFW_to_Richardson Location_for_D_to_R;

    // Then we have to initialize the super method of baseclass so that every property of BaseClass can be access easily
    public DFW_to_Richardson_test() {
        super();
    }
    ...
    public void DFWtoRichardson() {
        ...
        Location_for_D_to_R = new DFW_to_Richardson();
    }
    ...
    public void validatethepage() {
        ...
        String title = Location_for_D_to_R.driver.getTitle();
    ...
    public Object[][] getData() throws IOException {
        ...
        return DataProviderClass.getExcelData("C:\\Users\\Fast Computers\\IdeaProjects\\PrestigeRide_Demo_Java_Selenium\\Test_Data\\Test_Data_for Location.xlsx", "Sheet1");
    }
    ...
    public void firstlocationtest(String pickup, String dropoff) throws InterruptedException {
        ...
        //Enter Details for first location - DFW to Richardson

        Location_for_D_to_R.entervalueinpickuplocation(pickup);
        ActionUtiles.waitForElementToBeVisible(Location_for_D_to_R.selectDropdownValue("DFW airport"));

        //Select DropoffLocation
        Location_for_D_to_R.entervaluefordropofflocation(dropoff);
        ActionUtiles.waitForElementToBeVisible(Location_for_D_to_R.selectDropdownValue("Richardson"));
        Location_for_D_to_R.setDate("25/12/2025");

        //Wait for manually set the time
        Thread.sleep(8000);
        Location_for_D_to_R.setTime("10","00","PM");
    }
        ...
        public void clickonsubmitbtn(){
            ...
            Location_for_D_to_R.clickonsubmit();

            // Wait for an element that confirms the page has loaded
            ActionUtiles.waitForElementToBeVisible(Location_for_D_to_R.getSearchResultsHeader());
    ...
    public void validatethesearchresultpage() {
        ...
        Location_for_D_to_R.waitForSearchResultPageToLoad();

        // Validate the page title after waiting for the page to load
        String pageTitle = Location_for_D_to_R.getSearchResultPageTitle();
